...
import java.util.UUID
   ...
   */
case class GetAllowedRestrictionsResponse(
  /* Operation ID. */
  correlationId: UUID,
  ...
  location: IikoTransportPublicApiContractsDeliveryRestrictionsAllowedRestrictionsGetAllowedRestrictionsResponseLocation,
  /* Suitable terminal groups with a delivery duration for them. */
  allowedItems: Seq[AllowedItemWithDuration],
  /* Rejected items with cause. */
  rejectedItems: Seq[RejectItem]
)
