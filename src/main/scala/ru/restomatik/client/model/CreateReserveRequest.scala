...
import java.util.UUID
   ...
   */
case class CreateReserveRequest(
  ...
  order: Option[IikoTransportPublicApiContractsReservesCreateReserveRequestOrder] = None,
  customer: RegularCustomer,
  /* Telephone number.  > Must begin with symbol \"+\" and must be at least 8 digits. */
  phone: String,
  /* Number of guests. */
  guestsCount: Option[Int] = None,
  ...
  guests: Option[IikoTransportPublicApiContractsReservesCreateReserveRequestGuests] = None,
  /* Event type.   > Allowed from version `8.5.6`. */
  eventType: Option[String] = None,
  createReserveSettings: Option[IikoTransportPublicApiContractsReservesCreateReserveRequestCreateReserveSettings] = None
)
