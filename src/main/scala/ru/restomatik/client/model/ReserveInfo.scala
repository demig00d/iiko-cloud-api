...
case class ReserveInfo(
  ...
  errorInfo: Option[IikoTransportPublicApiContractsReservesReserveInfoErrorInfo] = None,
  /* Banquet/reserve is deleted. */
  isDeleted: Boolean,
  reserve: Option[IikoTransportPublicApiContractsReservesReserveInfoReserve] = None
)

object ReserveInfoEnums {
