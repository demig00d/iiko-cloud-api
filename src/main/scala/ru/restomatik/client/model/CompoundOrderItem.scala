...
import ru.restomatik.client.model.OrderItemStatus._
   ...
   */
case class CompoundOrderItem(
  primaryComponent: CompoundOrderItemComponent,
  secondaryComponent: Option[CompoundOrderItemComponent] = None,
  /* Indivisible modifiers. */
  commonModifiers: Option[Seq[OrderItemModifier]] = None,
  template: Option[CompoundItemTemplate] = None,
  `type`: String,
