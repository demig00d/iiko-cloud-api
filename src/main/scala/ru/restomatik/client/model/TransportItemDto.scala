...
case class TransportItemDto(
  itemSizes: Option[Seq[TransportItemSizeDto]] = None,
  /* Product code */
  ...
  taxCategory: Option[TaxCategoryDto] = None,
  /* Product or compound. Depends on modifiers scheme existence */
  orderItemType: Option[TransportItemDtoEnums.OrderItemType] = None
)

object TransportItemDtoEnums {
