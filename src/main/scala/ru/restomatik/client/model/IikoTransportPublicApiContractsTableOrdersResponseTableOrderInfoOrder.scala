...
import ru.restomatik.client.model.SplitOrderBetweenCashRegisters._
...
import java.util.UUID
   ...
   */
case class IikoTransportPublicApiContractsTableOrdersResponseTableOrderInfoOrder(
  /* Table IDs.                Can be obtained by `/api/1/reserve/available_restaurant_sections` operation. */
  tableIds: Seq[UUID],
  customer: Option[IikoTransportPublicApiContractsTableOrdersResponseTableOrderCustomer] = None,
  /* Guest phone.   > Allowed from version `7.5.2`. */
  phone: Option[String] = None,
  status: OrderStatus,
  /* Order creation date (terminal time zone). */
  whenCreated: Option[String] = None,
  waiter: Option[IikoTransportPublicApiContractsTableOrdersResponseTableOrderWaiter] = None,
  /* Tab name (only for fastfood terminals group in tab mode). */
  tabName: Option[String] = None,
  splitOrderBetweenCashRegisters: Option[SplitOrderBetweenCashRegisters] = None,
  /* External menu ID. */
...
object IikoTransportPublicApiContractsTableOrdersResponseTableOrderInfoOrderEnums {
