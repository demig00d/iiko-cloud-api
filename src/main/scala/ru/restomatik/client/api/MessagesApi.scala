...
import ru.restomatik.client.model.{SendEmailRequest, SendSmsRequest}
import sttp.client3._
import sttp.model.Method

object MessagesApi {

def apply(baseUrl: String = "https://api-ru.iiko.services") = new MessagesApi(baseUrl)
}
...
class MessagesApi(baseUrl: String) {
   ...
   */
  def api1LoyaltyIikoMessageSendEmailPost(authorization: String, timeout: Option[Int] = None, sendEmailRequest: Option[SendEmailRequest] = None
   ...
   */
  def api1LoyaltyIikoMessageSendSmsPost(authorization: String, timeout: Option[Int] = None, sendSmsRequest: Option[SendSmsRequest] = None
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
