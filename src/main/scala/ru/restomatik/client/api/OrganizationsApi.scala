...
import ru.restomatik.client.model.{GetOrganizationsRequest, GetOrganizationsResponse}
import sttp.client3._
import sttp.model.Method

object OrganizationsApi {

def apply(baseUrl: String = "https://api-ru.iiko.services") = new OrganizationsApi(baseUrl)
}
...
class OrganizationsApi(baseUrl: String) {
   ...
   */
  def api1OrganizationsPost(authorization: String, timeout: Option[Int] = None, getOrganizationsRequest: Option[GetOrganizationsRequest] = None
