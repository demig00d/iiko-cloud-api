...
import ru.restomatik.client.model.{GetAccessTokenRequest, GetAccessTokenResponse}
import sttp.client3._
import sttp.model.Method

object AuthorizationApi {

def apply(baseUrl: String = "https://api-ru.iiko.services") = new AuthorizationApi(baseUrl)
}

class AuthorizationApi(baseUrl: String) {
   ...
   */
  def api1AccessTokenPost(timeout: Option[Int] = None, getAccessTokenRequest: Option[GetAccessTokenRequest] = None
