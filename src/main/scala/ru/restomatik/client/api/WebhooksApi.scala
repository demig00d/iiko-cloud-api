...
import ru.restomatik.client.model.{CorrelationIdResponse, GetWebHookSettingsRequest, GetWebHookSettingsResponse, UpdateWebHookSettingsRequest}
import sttp.client3._
import sttp.model.Method

object WebhooksApi {

def apply(baseUrl: String = "https://api-ru.iiko.services") = new WebhooksApi(baseUrl)
}
...
class WebhooksApi(baseUrl: String) {
  ...
  /**
   * Expected answers:
   *   code 200 : GetWebHookSettingsResponse (Success)
   ...
   * @param getWebHookSettingsRequest 
   */
  def api1WebhooksSettingsPost(authorization: String, timeout: Option[Int] = None, getWebHookSettingsRequest: Option[GetWebHookSettingsRequest] = None
): Request[Either[ResponseException[String, Exception], GetWebHookSettingsResponse], Any] =
    basicRequest
   ...
   * @param authorization Authorization token.
   * @param timeout Timeout in seconds.
   * @param updateWebHookSettingsRequest 
   */
  def api1WebhooksUpdateSettingsPost(authorization: String, timeout: Option[Int] = None, updateWebHookSettingsRequest: Option[UpdateWebHookSettingsRequest] = None
